    ...
    widgets: {
        ...
        widget2: {
            ...
            datasets  : [
                {
                    label: 'Products',
                    data : [221, 428, 492, 471, 413, 344, 294, 343, 343, 280, 240, 265 ]
                }
            ],
        ...
        widget3: {
            ...
            datasets   : [
                {
                    label: 'Whish List',
                    data : [67000, 54000, 82000, 57000, 72000, 57000, 87000, 72000, 89000, 98700, 112000, 136000],
                    fill : false
                }
            ],
        ...
        widget4: {
            ...
            datasets : [
                {
                    label: 'Visits',
                    data : [432, 428, 327, 363, 456, 267, 231, 380, 245, 220, 490, 370]
                }
            ],
            //labels   : ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'],
            labels : ['Jan', "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
